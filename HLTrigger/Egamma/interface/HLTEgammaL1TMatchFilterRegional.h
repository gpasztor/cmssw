...
class HLTEgammaL1TMatchFilterRegional : public HLTFilter {
  ...
  private:
    ...
    edm::InputTag candEgTag_;         // input tag identifying product contains egammas
    ...
    edm::EDGetTokenT<reco::RecoEcalCandidateCollection> candEgToken_;
  ...
  private:
    ...
    bool matchedToL1Cand(const l1t::EGammaVectorRef l1Cands,const float scEta,const float scPhi) const;
    bool matchedToL1Cand(const l1t::JetVectorRef l1Cands,const float scEta,const float scPhi) const;
};
